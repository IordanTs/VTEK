...
<head>
    ...
    <link rel="stylesheet" href="css/about-us-page-style.css" type="text/css">
...
<body>
    ...
    <div class="container">
        <div class="about-us-page">
            ...
            <br>
            <br>
            <p>Добре дошли в сайта на име VTEK! Създадохме този сайт, за да може потребителите да имат по-голямо удобство в ежедневието си и най-вече в тяхното свободно време. А именно това удобство идва от събирането на два вида уебсайта на едно място.
                Тези сайтова са: сайт за гледане на филми онлайн и сайт за гледане на най-различни видеоклипове. VTEK предоставя напълно безплатно (за сега :)) тази възможнос да получите два различни вида видеосъдържание на едно място. Идеята за създаването
                на този сайт дойде от раздразнението на хората да се прехвърлят от сайт в сайт, за да може да си отпочина и да гледат нещо интересно в свободното време. И накрая решихме да разработим сайт, който да обединява всичко това в едно. В него
                може да се гледа както видео съдържание, така и филми. Сега с натискането на един бутон имате на разположение повече от един избор за разпускане. Благодарим Ви, че избрахте нас! Пожелаваме Ви приятно гледане!
            </p>
            <img src="images/about-us.jpg" class="about-us-image">
        </div>
    </div>
    <!------------------------site info------------------->
    <footer class="info">
