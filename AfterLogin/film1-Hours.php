...
<body>
    ...
    <div class="container">
        <div class="play-container">
            <img src="films/Hours.2013/hours.jpg" class="play-img">
            <div class="play-text">
                ...
                <div class="trailer-container">
                    <div class="trailer-box">
                        ...
                        <video id="trailerideo" class="trailer" controls>
                            <source src="films/Hours.2013/Hours (2013) - Official Trailer (HD).mp4" type="video/mp4">
                        </video>
            ...
            <div class="video-container">
                <div class="video-box">
                    ...
                    <video id="movievideo" class="movie" controls>
                        <source src="films/Hours.2013/Hours.2013.BRRip.x264.AC3.BGAUDiO-SiSO.mp4" type="video/mp4">
                    </video>
            ...
            <div class="abount-movie-container">
                <h1><i>Hours</i></h1>
                <h3><u>Резюме:</u></h3>
                <p> Действието на напрегнатия трилър с Пол Уокър се развива в Ню Орлиънс, а историята се фокусира върху наскоро овдовелия Нолън, който след унищожителния ураган Катрина се оказва в капан на полуразрушена болница заедно със своята новородена
                    дъщеря и който прави всичко възможно за да опази нейния и своя живот.Мащабната буря е повредила електричеството в сградата и е само въпрос на време преди инкубатора в който се намира детето му да остане без захранване.Но най-големия
                    проблем за Нолън се оказва постоянно увеличаващото се ниво на навлезлата в болницата вода.
                </p>
                <h3 class="cast-heading"><u>Актьори:</u></h3>
                <div class="cast">
                    <div class="cast-box">
                        <img src="films/Hours.2013/polUokur.jpg" alt="" class="cast-img">
                        <span class="cast-title">Пол Уокър</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Hours.2013/rodrigez.jpg" alt="" class="cast-img">
                        <span class="cast-title">Хенесис Родригес</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Hours.2013/lormand.jfif" alt="" class="cast-img">
                        <span class="cast-title">Джуд Лорманд</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Hours.2013/bentli.jpg" alt="" class="cast-img">
                        <span class="cast-title">Тони Бентли</span>
                    </div>
                </div>
            </div>
            <div class="download">
                ...
                <div class="download-links">
                    <a href="films/Hours.2013/Hours.2013.BRRip.x264.AC3.BGAUDiO-SiSO.mp4" download>480p</a>
                    <a href="films/Hours.2013/Hours.2013.BRRip.x264.AC3.BGAUDiO-SiSO.mp4" download>720p</a>
                    <a href="films/Hours.2013/Hours.2013.BRRip.x264.AC3.BGAUDiO-SiSO.mp4" download>1080p</a>
                </div>
            </div>
        </div>
    </div>
