...
<body>
    ...
    <div class="container">
        <div class="play-container">
            <img src="films/BashMaistoraNaMore/BashMaistora.jpg" class="play-img">
            <div class="play-text">
                <i class="fa-solid fa-circle-play play-movie-button"></i>
                <h1>Баш Майстора на море</h1>
                <div class="rating">
                ...
                <div class="trailer-container">
                    <div class="trailer-box">
                        ...
                        <video id="trailerideo" class="trailer" controls>
                            <source src="films/BashMaistoraNaMore/Баш Майстора сваляч_480p.mp4" type="video/mp4">
                        </video>
            ...
            <div class="video-container">
                <div class="video-box">
                    ...
                    <video id="movievideo" class="movie" controls>
                        <source src="films/BashMaistoraNaMore/Баш Майстора на море 1982г_480p.mp4" type="video/mp4">
                    </video>
            ...
            <div class="abount-movie-container">
                <h1><i>Баш Майстора на море</i></h1>
                <h3><u>Резюме:</u></h3>
                <p>Баш майсторът заминава на море с жена си и сина си. Пътят им минава край бостан с дини и те напълват багажника с крадени плодове, които впоследствие изхвърлят, тъй като милицията тръгва след тях. Малко по-късно, по стечение на обстоятелствата,
                    те са теглени от камион, превозващ дини, до автосервиз в Бургас, тъй като колата им се поврежда, а е и със смачкана предница след внезапно спиране на камиона. След като разбира, че няма да може да си поправи колата по стандартния начин
                    в сервиза, той се обръща към автотенекеджията Алекси Бебов да му изчука колата на частно. Уговорката е той да му поправи колата, а Баш майсторът да му измаже стаята. Бебов оправя смачканата предница, но не сменя изгорялата гарнитура
                    и Баш Майсторът е принуден да обиколи из страната, докато открие нова. В поредица от хитри надлъгвания накрая и двамата остават без това, за което са се договорили.
                </p>
                <h3 class="cast-heading"><u>Актьори:</u></h3>
                <div class="cast">
                    <div class="cast-box">
                        <img src="films/BashMaistoraNaMore/gospodinov.jpg" alt="" class="cast-img">
                        <span class="cast-title">Кирил Господинов</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/BashMaistoraNaMore/chesmedjiewa.jpg" alt="" class="cast-img">
                        <span class="cast-title">Людмила Чешмеджиева</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/BashMaistoraNaMore/qkowlew.jpg" alt="" class="cast-img">
                        <span class="cast-title">Юрий Яковлев</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/BashMaistoraNaMore/peew.jpg" alt="" class="cast-img">
                        <span class="cast-title">Светослав Пеев</span>
                    </div>
                </div>
            </div>
            <div class="download">
                ...
                <div class="download-links">
                    <a href="films/BashMaistoraNaMore/Баш Майстора на море 1982г_480p.mp4" download>480p</a>
                    <a href="films/BashMaistoraNaMore/Баш Майстора на море 1982г_480p.mp4" download>720p</a>
                    <a href="films/BashMaistoraNaMore/Баш Майстора на море 1982г_480p.mp4" download>1080p</a>
                </div>
            </div>
        </div>
    </div>
