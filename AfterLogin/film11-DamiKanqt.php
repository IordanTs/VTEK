...
<body>
    ...
    <div class="container">
        <div class="play-container">
            <img src="films/DamiKanqt/DamiKanqt.jpg" class="play-img">
            <div class="play-text">
                ...
                <div class="trailer-container">
                    <div class="trailer-box">
                        ...
                        <video id="trailerideo" class="trailer" controls>
                            <source src="films/DamiKanqt/Дами канят трейлър_480p.mp4" type="video/mp4">
                        </video>
            ...
            <div class="video-container">
                <div class="video-box">
                    ...
                    <video id="movievideo" class="movie" controls>
                        <source src="films/DamiKanqt/DAMI KANYAT_480p.mp4" type="video/mp4">
                    </video>
            ...
            <div class="abount-movie-container">
                <h1><i>Дами канят</i></h1>
                <h3><u>Резюме:</u></h3>
                <p>Чаровният инструктор по шофиране Яким Донев след развода си се отдава на лекомислени авантюри. И въпреки че всяка от жените, които го ухажват, се опитва здраво да го впримчи, неотразимият Дон Жуан успява да излезе от всякакви капани. Младият
                    почитател на любовните афери има инцидентни проблеми с ревниви съпрузи, но много по-сериозни са проблемите му с преследващите го влюбени жени.
                </p>
                <h3 class="cast-heading"><u>Актьори:</u></h3>
                <div class="cast">
                    <div class="cast-box">
                        <img src="films/DamiKanqt/kokanow.jfif" alt="" class="cast-img">
                        <span class="cast-title">Невена Коканова</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/DamiKanqt/danailow.jpg" alt="" class="cast-img">
                        <span class="cast-title">Стефан Данаилов</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/DamiKanqt/todew.jpg" alt="" class="cast-img">
                        <span class="cast-title">Никола Тодев</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/DamiKanqt/statulowa.jpg" alt="" class="cast-img">
                        <span class="cast-title">Мария Статулова</span>
                    </div>
                </div>
            </div>
            <div class="download">
                ...
                <div class="download-links">
                    <a href="films/DamiKanqt/DAMI KANYAT_480p.mp4" download>480p</a>
                    <a href="films/DamiKanqt/DAMI KANYAT_480p.mp4" download>720p</a>
                    <a href="films/DamiKanqt/DAMI KANYAT_480p.mp4" download>1080p</a>
                </div>
            </div>
        </div>
    </div>
