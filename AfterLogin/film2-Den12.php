...
<body>
    ...
    <div class="container">
        <div class="play-container">
            <img src="films/The.12th.Man/the12men.jpg" class="play-img">
            <div class="play-text">
                ...
                <div class="trailer-container">
                    <div class="trailer-box">
                        ...
                        <video id="trailerideo" class="trailer" controls>
                            <source src="films/The.12th.Man/The 12th Man (2017) - Trailer.mp4" type="video/mp4">
                        </video>
            ...
            <div class="abount-movie-container">
                <h1><i>The 12th Man</i></h1>
                <h3><u>Резюме:</u></h3>
                <p>Група бойци от норвежката съпротива е натоварена със задачата да стигне до северозападния норвежки бряг на кораба Bratholm и да извърши саботаж в една от германските въздушни бази. Мисията обаче претърпява фиаско още в морето, корабът
                    е нападнат от немски кораб и потъва. Единственият човек, който успява да се спаси е Ян Болсруд. Той успява да стигне до брега и да тръгне към шведската граница. Преследван от гестапо, Болсруд търси убежище в планините. Там е застигнат
                    от снежна буря, скрива се в пещера, която се оказва смъртоносен капан.
                </p>
                <h3 class="cast-heading"><u>Актьори:</u></h3>
                <div class="cast">
                    <div class="cast-box">
                        <img src="films/The.12th.Man/gulestad.jpg" alt="" class="cast-img">
                        <span class="cast-title">Томас Гулестад</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/The.12th.Man/maiurs.jfif" alt="" class="cast-img">
                        <span class="cast-title">Джонатан Рис Майърс</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/The.12th.Man/blokhus.jpg" alt="" class="cast-img">
                        <span class="cast-title">Мари Блокхус</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/The.12th.Man/frikstad.jpg" alt="" class="cast-img">
                        <span class="cast-title">Даниел Фрикстад</span>
                    </div>
                </div>
            </div>
            <div class="download">
                ...
                <div class="download-links">
                    <a href="films/The.12th.Man/The 12th Man (2017) - Trailer.mp4" download>480p</a>
                    <a href="films/The.12th.Man/The 12th Man (2017) - Trailer.mp4" download>720p</a>
                    <a href="films/The.12th.Man/The 12th Man (2017) - Trailer.mp4" download>1080p</a>
                </div>
            </div>
        </div>
    </div>
