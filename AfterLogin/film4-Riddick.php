...
<body>
    ...
    <div class="container">
        <div class="play-container">
            <img src="films/Riddick/riddik.jpg" class="play-img">
            <div class="play-text">
                ...
                <div class="trailer-container">
                    <div class="trailer-box">
                        ...
                        <video id="trailerideo" class="trailer" controls>
                            <source src="films/Riddick/Riddick Official TRAILER 1 2013  Vin Diesel Karl Urban Movie HD_1080p (2).mp4" type="video/mp4">
                        </video>
            ...
            <div class="abount-movie-container">
                <h1><i>Riddick</i></h1>
                <h3><u>Резюме:</u></h3>
                <p> Действието на дългоочаквания “Ридик” се развива няколко години след събитията описани във втората част, а сюжетът отново се фокусира върху бившия затворник Ричард Ридик, който е изоставен от своите хора на облъчена от слънчева радиация
                    планета. А повърхноста й е населена с най-различни хищни същества. За да оцелее в тази среда, Ридик е принуден да се бори не само срещу опасните хищници, но и срещу отряд от наемници, чиято основна цел е да го елиминират и получат
                    предлаганата парична награда за главата му. Друг сериозен проблем е и странния преследвач, чиито действия, за разлика от наемниците, са подтиквани единствено от личната му омраза към Ридик.

                </p>
                <h3 class="cast-heading"><u>Актьори:</u></h3>
                <div class="cast">
                    <div class="cast-box">
                        <img src="films/Riddick/dizel.png" alt="" class="cast-img">
                        <span class="cast-title">Вин Дизел</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Riddick/batista.jpg" alt="" class="cast-img">
                        <span class="cast-title">Дейв Батиста</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Riddick/sakhof.png" alt="" class="cast-img">
                        <span class="cast-title">Кейти Сакхоф</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Riddick/molla.jfif" alt="" class="cast-img">
                        <span class="cast-title">Джорди Молла</span>
                    </div>
                </div>
            </div>
            <div class="download">
                ...
                <div class="download-links">
                    <a href="films/Riddick/Riddick Official TRAILER 1 2013  Vin Diesel Karl Urban Movie HD_1080p.mp4" download>480p</a>
                    <a href="films/Riddick/Riddick Official TRAILER 1 2013  Vin Diesel Karl Urban Movie HD_1080p.mp4" download>720p</a>
                    <a href="films/Riddick/Riddick Official TRAILER 1 2013  Vin Diesel Karl Urban Movie HD_1080p.mp4" download>1080p</a>
                </div>
            </div>
        </div>
    </div>
