...
<body>
    ...
    <div class="container">
        <div class="play-container">
            <img src="films/Rampage/Rampage.jpg" class="play-img">
            <div class="play-text">
                ...
                <div class="trailer-container">
                    <div class="trailer-box">
                        ...
                        <video id="trailerideo" class="trailer" controls>
                            <source src="films/Rampage/RAMPAGE  OFFICIAL TRAILER 1 HD_1080p.mp4" type="video/mp4">
                        </video>
            ...
            <div class="abount-movie-container">
                <h1><i>Rampage</i></h1>
                <h3><u>Резюме:</u></h3>
                <p> Дейвис Окойе (Дуейн Джонсън) е приматолог, чийто най-добър приятел е Джордж – изключително интелигентна горила, за която той се е грижил от раждането й. Генетичен експеримент, който се проваля, превръща обикновеното животно в разярен звяр
                ...
                <div class="cast">
                    <div class="cast-box">
                        <img src="films/Rampage/skalata.jpg" alt="" class="cast-img">
                        <span class="cast-title">Дуейн Джонсън</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Rampage/haris.jpg" alt="" class="cast-img">
                        <span class="cast-title">Наоми Харис</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Rampage/akerman.jfif" alt="" class="cast-img">
                        <span class="cast-title">Малин Акерман</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Rampage/morgan.jpg" alt="" class="cast-img">
                        <span class="cast-title">Джефри Дийн Морган</span>
                    </div>
                </div>
            </div>
            <div class="download">
                ...
                <div class="download-links">
                    <a href="films/Rampage/RAMPAGE  OFFICIAL TRAILER 1 HD_1080p.mp4" download>480p</a>
                    <a href="films/Rampage/RAMPAGE  OFFICIAL TRAILER 1 HD_1080p.mp4" download>720p</a>
                    <a href="films/Rampage/RAMPAGE  OFFICIAL TRAILER 1 HD_1080p.mp4" download>1080p</a>
                </div>
            </div>
        </div>
    </div>
