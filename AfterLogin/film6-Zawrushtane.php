...
<body>
    ...
    <div class="container">
        <div class="play-container">
            <img src="films/Zawrushtane/Zawrushtane.jpg" class="play-img">
            <div class="play-text">
                ...
                <div class="trailer-container">
                    <div class="trailer-box">
                        ...
                        <video id="trailerideo" class="trailer" controls>
                            <source src="films/Zawrushtane/ЗАВРЪЩАНЕ трейлър 4К_1080p.mp4" type="video/mp4">
                        </video>
            ...
            <div class="video-container">
                <div class="video-box">
                    ...
                    <video id="movievideo" class="movie" controls>
                        <source src="films/Zawrushtane/Завръщане 2019.mp4" type="video/mp4">
                    </video>
            ...
            <div class="abount-movie-container">
                <h1><i>Завръщане</i></h1>
                <h3><u>Резюме:</u></h3>
                <p> Точно 25 години след паметното футболно лято на България през 94-та, трима приятели се завръщат у дома от всички краища на света, за да помогнат на друг свой приятел от детството да спаси родната си къща. Алекс трябва да убеди братовчед
                    си Бранимир да не загърбва завета на дядо им, като събори фамилния им дом и построи на негово място модерна бизнес сграда. Единственият начин за това е приятелите от детството да се обединят отново и да победят професионалния отбор
                    на Бранимир в градския маратон. Задачата се оказва изключително трудна, а поредица от безумни случки и абсурдни препятствия поставят на изпитания дългогодишното им приятелство.
                </p>
                <h3 class="cast-heading"><u>Актьори:</u></h3>
                <div class="cast">
                    <div class="cast-box">
                        <img src="films/Zawrushtane/kostowa.jpg" alt="" class="cast-img">
                        <span class="cast-title">Евелин Костова</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Zawrushtane/rahal.jfif" alt="" class="cast-img">
                        <span class="cast-title">Башар Рахал</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Zawrushtane/krustanow.jpg" alt="" class="cast-img">
                        <span class="cast-title">Бойко Кръстанов</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Zawrushtane/karlarahal.jpg" alt="" class="cast-img">
                        <span class="cast-title">Карла Рахал</span>
                    </div>
                </div>
            </div>
            <div class="download">
                ...
                <div class="download-links">
                    <a href="films/Zawrushtane/ЗАВРЪЩАНЕ трейлър 4К_1080p.mp4" download>480p</a>
                    <a href="films/Zawrushtane/ЗАВРЪЩАНЕ трейлър 4К_1080p.mp4" download>720p</a>
                    <a href="films/Zawrushtane/ЗАВРЪЩАНЕ трейлър 4К_1080p.mp4" download>1080p</a>
                </div>
            </div>
        </div>
    </div>
