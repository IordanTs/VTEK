...
<body>
    ...
    <div class="container">
        <div class="play-container">
            <img src="films/GospodinZaEdinDen/gospodinzaedinden.jpg" class="play-img">
            <div class="play-text">
                <i class="fa-solid fa-circle-play play-movie-button"></i>
                <h1>Господин за един ден</h1>
                <div class="rating">
                ...
                <div class="trailer-container">
                    <div class="trailer-box">
                        ...
                        <video id="trailerideo" class="trailer" controls>
                            <source src="films/GospodinZaEdinDen/Господин за един ден или Todor Kolev forever_480p.mp4" type="video/mp4">
                        </video>
            ...
            <div class="video-container">
                <div class="video-box">
                    ...
                    <video id="movievideo" class="movie" controls>
                        <source src="films/GospodinZaEdinDen/Господин за един ден _ King for a day (1983).mp4" type="video/mp4">
                    </video>
            ...
            <div class="abount-movie-container">
                <h1><i>Господин за един ден</i></h1>
                <h3><u>Резюме:</u></h3>
                <p> България от 20-те години на XX век. Пурко (Тодор Колев) е беден селски музикант, който непрекъснато измисля нови и нови начини да надхитря живота и да изхранва многолюдното си семейство. Преминавайки през редица смешни и тъжни приключения
                    в борбата с немотията, един хубав ден той докосва мечтата си – превръща се в добре облечен градски господин. Дали обаче новата му самоличност ще пасне на свободната душа на музиканта? Илюзията рухва, но Пурко намира кураж отново да
                    надуе своя кларинет.
                </p>
                <h3 class="cast-heading"><u>Актьори:</u></h3>
                <div class="cast">
                    <div class="cast-box">
                        <img src="films/GospodinZaEdinDen/kolew.jpg" alt="" class="cast-img">
                        <span class="cast-title">Тодор Колев</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/GospodinZaEdinDen/stefanowa.jpg" alt="" class="cast-img">
                        <span class="cast-title">Йорданка Стефанова</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/GospodinZaEdinDen/finci.jpg" alt="" class="cast-img">
                        <span class="cast-title">Ицко Финци</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/GospodinZaEdinDen/gudew.jpg" alt="" class="cast-img">
                        <span class="cast-title">Стоян Гъдев</span>
                    </div>
                </div>
            </div>
            <div class="download">
                ...
                <div class="download-links">
                    <a href="films/GospodinZaEdinDen/Господин за един ден _ King for a day (1983).mp4" download>480p</a>
                    <a href="films/GospodinZaEdinDen/Господин за един ден _ King for a day (1983).mp4" download>720p</a>
                    <a href="films/GospodinZaEdinDen/Господин за един ден _ King for a day (1983).mp4" download>1080p</a>
                </div>
            </div>
        </div>
    </div>
