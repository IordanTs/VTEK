...
<body>
    ...
    <div class="container">
        <div class="play-container">
            <img src="films/Lubimec13/lubimec13.jpg" class="play-img">
            <div class="play-text">
                ...
                <div class="trailer-container">
                    <div class="trailer-box">
                        ...
                        <video id="trailerideo" class="trailer" controls>
                            <source src="films/Lubimec13/Любимец 13 1958_1080p.mp4" type="video/mp4">
                        </video>
            ...
            <div class="video-container">
                <div class="video-box">
                    ...
                    <video id="movievideo" class="movie" controls>
                        <source src="films/Lubimec13/Lyubimetz 13 1958 Любимец 13.mp4" type="video/mp4">
                    </video>
            ...
            <div class="abount-movie-container">
                <h1><i>Любимец 13</i></h1>
                <h3><u>Резюме:</u></h3>
                <p> Радослав и Радосвет са братя близнаци (и двете роли се играят от Апостол Карамитев) от Варна. Радослав играе в местен футболен отбор. На плажа се запознава с Елена (Гинка Станчева), красиво момиче от София, и се влюбва в нея. Радосвет
                    е противоположност на брат си — заплашен от съд за неплатени дългове, той решава да се възползва от приликата с брат си и да заеме мястото му. Докато Радослав заминава за София, за да търси Елена, Радосвет се представя за футболиста
                    Гълъбов и приема предложението за голяма заплата от ведомствения отбор на софийското предприятие ДП „Витоша“, чийто директор Строгов (Пенчо Петров) е голям футболен запалянко. Следват поредица от комични случки, докато служителите
                    на ДП „Витоша“ Гого (Георги Карев) и Пеци (Петко Карлуковски) се опитват да попречат на Рашо Чуков (Енчо Тагаров) и Гочо Полянски (Георги Парцалев) да привлекат Гълъбов в своите отбори в Русе и Пловдив. В София Елена среща Радосвет
                    и, обидена от нахалното му държане, му удря шамар. След този инцидент Елена случайно среща и Радослав, който изяснява недоразумението. Двамата отиват на мача, на който Радосвет играе с номер 13. След комични положения, предизвикани
                    от него, отборът му губи мача и всички разбират за подмяната. Радослав получава предложение да остане в София, но отказва.
                </p>
                <h3 class="cast-heading"><u>Актьори:</u></h3>
                <div class="cast">
                    <div class="cast-box">
                        <img src="films/Lubimec13/karamitew.jfif" alt="" class="cast-img">
                        <span class="cast-title">Апостол Карамитев</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Lubimec13/stanchewa.jfif" alt="" class="cast-img">
                        <span class="cast-title">Гинка Станчева</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Lubimec13/hranowa.jpg" alt="" class="cast-img">
                        <span class="cast-title">Елена Хранова</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Lubimec13/parcalew.jpg" alt="" class="cast-img">
                        <span class="cast-title">Георги Парцалев</span>
                    </div>
                </div>
            </div>
            <div class="download">
                ...
                <div class="download-links">
                    <a href="films/Lubimec13/Lyubimetz 13 1958 Любимец 13.mp4" download>480p</a>
                    <a href="films/Lubimec13/Lyubimetz 13 1958 Любимец 13.mp4" download>720p</a>
                    <a href="films/Lubimec13/Lyubimetz 13 1958 Любимец 13.mp4" download>1080p</a>
                </div>
            </div>
        </div>
    </div>
