...
<body>
    ...
    <div class="container">
        <table class="main-page-table">
            <tr>
                <td class="video-square">
                    <a href="video-page.php">
                        <img src="images/videos-picture.jpg" class="video-picture">
                        <div class="overlay">
                            <div class="content">
                                <h1>Видеа</h1>
                            </div>
                ...
                <td class="film-square">
                    <a href="film-page.php">
                        <img src="images/films-picture.jpg" class="film-picture">
                        <div class="overlay">
                            <div class="content">
                                <h1>Филми</h1>
                            </div>
