...
<body>
    ...
    <div class="container">
        <div class="play-container">
            <img src="films/Oblivion.2013/Oblivion-banner.jpg" class="play-img">
            <div class="play-text">
                ...
                <div class="trailer-container">
                    <div class="trailer-box">
                        ...
                        <video id="trailerideo" class="trailer" controls>
                            <source src="films/Oblivion.2013/Oblivion Trailer.mp4" type="video/mp4">
                        </video>
            ...
            <div class="video-container">
                <div class="video-box">
                    ...
                    <video id="movievideo" class="movie" controls>
                        <source src="films/Oblivion.2013/Oblivion.2013.mp4" type="video/mp4">
                    </video>
            ...
            <div class="abount-movie-container">
                <h1><i>Oblivion</i></h1>
                <h3><u>Резюме:</u></h3>
                <p>В далечното бъдеще, когато земната повърхност е напълно разрушена от силна слънчева светлина, оцелелите от тази катастрофа живеят над облаците. Безопасно място, което ги държи далеч от радиоактивната повърхност и съществата, които те бродят
                    ...
                    от събития - събития, които ще променят не само живота му, но и живота на всички оцелели.
                </p>
                <h3 class="cast-heading"><u>Актьори:</u></h3>
                <div class="cast">
                    <div class="cast-box">
                        <img src="films/Oblivion.2013/actiors/TomKrus.jpg" alt="" class="cast-img">
                        <span class="cast-title">Том Круз</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Oblivion.2013/actiors/OlgaKurilenko.jpg" alt="" class="cast-img">
                        <span class="cast-title">Олга Куриленко</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Oblivion.2013/actiors/MorganFriiman.jpg" alt="" class="cast-img">
                        <span class="cast-title">Морган Фрийман</span>
                    </div>
                    <div class="cast-box">
                        <img src="films/Oblivion.2013/actiors/AdreanaRaisboro.jpg" alt="" class="cast-img">
                        <span class="cast-title">Андрея Райзбъро</span>
                    </div>
                </div>
            </div>
            <div class="download">
                ...
                <div class="download-links">
                    <a href="films/Oblivion.2013/Oblivion.2013.mp4" download>480p</a>
                    <a href="films/Oblivion.2013/Oblivion.2013.mp4" download>720p</a>
                    <a href="films/Oblivion.2013/Oblivion.2013.mp4" download>1080p</a>
                </div>
            </div>
        </div>
    </div>
