        ...
        <div class="row">
            <div class="play-video">
                <video controls autoplay>
                    <source src="videos/Mega Hits 2021  The Best Of Vocal Deep House Music Mix 2021  Summer Music Mix 2021 9.mp4" type="video/mp4">
                </video>
                <h3>Mega Hits 2021 🌱 The Best Of Vocal Deep House Music Mix 2021 🌱 Summer Music Mix 2021 #9</h3>
                <div class="play-video-info">
                    <p>
                        <span id="views"></span> гледания • качено: преди 2 часа
                    </p>
                    <a href="videos/Mega Hits 2021  The Best Of Vocal Deep House Music Mix 2021  Summer Music Mix 2021 9.mp4" download>
                ...
                <div class="vid-discription">
                    ...
                    <div class="add-coment">
                        ...
                        ?>
                        <?php
                            echo "<form method='POST' action='setmessage.php' class='new-comment'>
                            <input type='text' placeholder='Име...' name='username' class='coment-text' required>
                            <input type='hidden' name='date' value='".date('Y-m-d H:i:s')."'>
                            <input type='text' placeholder='Напиши коментар...' name='comment' class='coment-text' required>
                            <button type='submit' name='commentSubmit' class='post-putton'>Коментирай</button>
                            </form>";
                        ?>
                    </div>
            ...
            <div class="right-sidebar">
                ...
                <div class="side-video-list">
                    <a href="video2-Rag'n'BoneMan-Human.php" class="small-thumbnail"><img src="images/human.jpg"></a>
                    <div class="vid-info">
                        <a href="video2-Rag'n'Bone Man - Human.php">Rag'n'Bone Man - Human</a>
                        <p>Ритъм</p>
                    </div>
                </div>
                <div class="side-video-list">
                    <a href="video3-Otilia - Bilionera (official video)" class="small-thumbnail"><img src="images/bilionera.jpg  "></a>
                    <div class="vid-info">
                        <a href="video3-Otilia - Bilionera (official video)">Otilia - Bilionera (official video)</a>
                        <p>Ритъм</p>
                    </div>
                </div>
                <div class="side-video-list">
                ...
                <div class="side-video-list">
                    <a href="video9-НовинитенаNOVA(31.03.2022-централнаемисия).php" class="small-thumbnail"><img src="images/novini4.jpg"></a>
                    <div class="vid-info">
