...
<head>
    ...
    <link rel="stylesheet" href="css/terms-and-conditions.css" type="text/css">
...
<body>
    ...
    <div class="container">
        <div class="terms-and-conditions">
            <h1 class="title">Правила и условия</h1>
            <hr class="line">
            <br>
            <br>
            <br>
            <p>Ако сте под необходимата възраст, за да управлявате свой собствен профил в VTEK, трябва да имате разрешение от родител или законен настойник за използването на такъв профил. Помолете някой от родителите си или законния си настойник да прочете
                тези Общи условия заедно с вас. Ако сте родител или законен настойник и позволите на детето си да използва услугите, тези Общи условия са приложими за вас и носите отговорност за активността му в услугите. За някои услуги на Google има
                допълнителни възрастови изисквания, които са описани в допълнителните Общи условия и правилата на ниво услуга.
            </p>
            <br>
            <p>Опазването на поверителността на твоите лични данни е много важно за нас, затова разработихме настоящата Политика за конфиденциалност, за да разбереш как ги събираме и използваме. Политиката ни по опазването на твоите лични данни е изцяло
                в синхрон със Закона за защита на личните данни, както и с Общия европейски регламент за защита на личните данни - Регламент (ЕС) 2016/679, в сила от 25 май 2018 г. Сайтът VTEK е собственост на фирма VTEK ЕООД. Когато посетиш нашия уебсайт,
                VTEK ЕООД ще научи определена информация за теб по време на твоето посещение.
            </p>
            <br>
            <h2 class="title">Лични данни при посещение на сайта</h2>
            <hr class="line">
            <br>
            <p>Най-общо казано, ние използваме личната ти информация за целите на администрирането на нашата бизнес дейност, за предоставяне на отлично клиентско обслужване и за да направим достъпни нашите продукти и услуги за нашите настоящи и потенциални
                клиенти. Клийн Канвас няма да получи лично идентифицираща те информация, когато посетиш нашия сайт, освен ако ти не решиш да ни предоставиш такава информация, нито ще продаде или прехвърли по друг начин такава информация до несвързани
                трети лица без съгласието ти в момента на събирането ѝ. Ние може да разкрием такава информация, само ако сме законово принудени да го направим. С други думи, когато смятаме, че законът го изисква или за да защитим нашите законни права.
            </p>
            <img src="images/terms-and-conditions.jpg" class="image-terms">
        </div>
    </div>
    <!------------------------site info------------------->
    <footer class="info">
