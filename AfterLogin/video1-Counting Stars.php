...
<head>
    ...
    <script async src="https://api.countapi.xyz/hit/vtek.com/fb57cf22-4518-4c87-b204-95884f1ead02?callback=videoViews"></script>
</head>
        ...
        <div class="row">
            <div class="play-video">
                <video controls autoplay>
                    <source src="videos/OneRepublic-Counting-Stars-Official-Music-Video_1080p.mp4" type="video/mp4">
                </video>
                <h3>OneRepublic - Counting Stars (Official Music Video)</h3>
                <div class="play-video-info">
                    <p>
                        <span id="views"></span> гледания • качено: преди 2 часа
                    </p>
                    <a href="videos/OneRepublic-Counting-Stars-Official-Music-Video_1080p.mp4" download>
            ...
            <div class="right-sidebar">
                ...
                <div class="side-video-list">
                    <a href="video3-Otilia - Bilionera (official video).php" class="small-thumbnail"><img src="images/one-republic.jpg  "></a>
                    <div class="vid-info">
