...
<head>
    ...
    <script async src="https://api.countapi.xyz/hit/vtek.com/4fb7e9b7-1777-4b91-b027-fd65fb13cd2d?callback=videoViews"></script>
</head>
        ...
        <div class="row">
            <div class="play-video">
                <video controls autoplay>
                    <source src="videos/Капитан Петко Войвода.mp4" type="video/mp4">
                </video>
                <h3>YAKU - Капитан Петко Войвода / Kapitan Petko Voivoda - Официална Версия</h3>
                <div class="play-video-info">
                    <p>
                        <span id="views"></span> гледания • качено: преди 18 часа
                    </p>
                    <a href="videos/Капитан Петко Войвода.mp4" download>
