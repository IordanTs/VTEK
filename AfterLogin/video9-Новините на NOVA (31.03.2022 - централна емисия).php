...
<head>
    ...
    <script async src="https://api.countapi.xyz/hit/vtek.com/06c2f942-76c8-4f9e-ade3-23de06a798ac?callback=videoViews"></script>
</head>
        ...
        <div class="row">
            <div class="play-video">
                <video controls autoplay>
                    <source src="videos/Новините на NOVA (31.03.2022 - централна емисия).mp4" type="video/mp4">
                </video>
                <h3>Новините на NOVA (31.03.2022 - централна емисия)</h3>
                <div class="play-video-info">
                    <p>
                        <span id="views"></span> гледания • качено: преди 18 часа
                    </p>
                    <a href="videos/Новините на NOVA (31.03.2022 - централна емисия).mp4" download>
                ...
                <div class="vid-discription">
                    ...
                    <div class="old-comment">
                        ...
                        <div>
                            <h3>User14556</h3>
                            <p>Наближава първи април. Ден на българската журналистика!🤥</p>
                        </div>
                    </div>
                    <div class="old-comment">
                        <i class="fa-solid fa-comment-dots comment-icon"></i>
                        <div>
                            <h3>Ivan</h3>
                            <p>
                                "може да се създаде хаос в Здравната система!" - по-голям смях може ли да произведете?
                            </p>
                        </div>
                    </div>
                    <div class="old-comment">
                        ...
                        <div>
                            <h3>Koceto</h3>
                            <p>Голямо решение взеха няма що маските си остават на обществени места 😁😁😁</p>
                        </div>
                    </div>
                    <div class="old-comment">
                        <i class="fa-solid fa-comment-dots comment-icon"></i>
                        <div>
                            <h3>Michael</h3>
                            <p>Чак улица Украйна. Абе вие луди ли сте ееее.</p>
                        </div>
                    </div>
                </div>
            </div>
