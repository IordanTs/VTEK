        ...
        <div class="login-container">
            ...
            <form method="post" action="Login.php" class="login-form">
                ...
                <div class="input-group">
                    <input type="text" placeholder="Потребителско име" name="username" class="textboxes"><br><br>
                    <input type="password" placeholder="Парола" name="password" class="textboxes">
                </div>
                <button type="submit" class="btn" name="login_button">Вход</button>
                <p class="login-text">
                    Нямате акаунт? <a href="Register.php">Регистрация</a>
                </p>
            </form>
        </div>
    </div>
